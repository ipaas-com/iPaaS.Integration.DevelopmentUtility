...
namespace IntegrationDevelopmentUtility.ValidationTester
{
    ...
    {
        public static void ExecuteTestCase(string methodName, long systemId)
        {
            ...
            try
            {
                var tupleResults = ValidationTester.CreateConnection.Create(Settings.Instance.IntegrationFileLocation, "", system, company.CompanySpecificFullToken, company.iPaaSSystemId);
