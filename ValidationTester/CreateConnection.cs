...
namespace IntegrationDevelopmentUtility.ValidationTester
{
    public class CreateConnection
    {
        ...
        public static Tuple<Integration.Abstract.Connection, object> Create(string assemblyPath, string dllNamespace, SettingResponse settings, FullToken apiToken, long iPaaSSystemId)
        {
            ...
            connection.ExternalSystemType = settings.SystemTypeId;
            ...
            connection.Settings.SystemTypeId = settings.SystemTypeId;
            ...
            dynamicConnection.CallWrapper.EstablishConnection(connection, connection.Settings);
