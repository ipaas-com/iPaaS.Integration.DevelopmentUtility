...
{
    public class DynamicFormulaResponse
    {
        ...
        [JsonProperty("integration_id", Order = 25)]
        public string SystemTypeId { get; set; }

        [JsonProperty("integration_version_id", Order = 30)]
        public string SystemTypeVersionId { get; set; }

        [JsonProperty("return_parameter", Order = 35)]
        public ReturnParameterResponse ReturnParameter { get; set; }

        [JsonProperty("parameters", Order = 40)]
        public List<DynamicFormulaParameterResponse> Parameters { get; set; }
    }
}
