...
namespace IntegrationDevelopmentUtility.Utilities
{
    public class StandardUtilities
    {
        ...
        private static bool Login(string username, string password)
        {
            ...
            StandardUtilities.WriteToConsole("Downloaded company list successfully", StandardUtilities.Severity.LOCAL);
        ...
        public static async Task LoginToACompany(Guid companyId)
        {
            ...
            var allSystems = iPaaSCallWrapper.Settings(company.CompanySpecificFullToken);
            company.Systems = allSystems;

            if (company.Systems == null)
            {
                company.Systems = new List<SettingGetAllResponse>();
                return;
            }
            ...
            {
                var systemSetting = iPaaSCallWrapper.Setting(Convert.ToString(system.Id), company.CompanySpecificFullToken);
        ...
        {
            var systemZero = new SettingResponse();
            ...
            var systemZeroGetAll = new SettingGetAllResponse();
            ...
            if (Settings.Instance.Companies.Count == 0)
            {
                ...
                if (companyInfo.Systems == null)
                    companyInfo.Systems = new List<SettingGetAllResponse>();
        ...
        public static void PrintUsageDetail(string command)
        {
            ...
            else if (command.ToUpper() == "UPLOAD")
            {
                ...
                hookUsage.UsageSummary = "Usage: UPLOAD <Filename>";
                hookUsage.Example = "Example: UPLOAD \"C:\\DevEnvironment\\MyIntegrationApplciation.BUILDMODELS.dll\"";
            ...
            else if (command.ToUpper() == "BUILDMODELS")
            {
                ...
                hookUsage.Parameters.Add(new UsageDisplayParameter() { Name = "API", Description = "The requested API where the request and response structure will come from. " +
        ...
        public static bool ValidateNotProduction()
        {
            ...
            if (Settings.Instance.IntegrationUrl.ToLower().StartsWith("https://api.ipaas.com/integrations"))
                return false;
